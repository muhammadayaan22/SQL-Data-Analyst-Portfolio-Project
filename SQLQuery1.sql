...
FROM 'C:\Users\M.I COMPUTERS\Downloads\cd6ca6c9bd83423ba5eabf06ab3d50f2\sql-data-analytics-project\datasets\flat-files\dim_customers.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
...
FROM 'C:\Users\M.I COMPUTERS\Downloads\cd6ca6c9bd83423ba5eabf06ab3d50f2\sql-data-analytics-project\datasets\flat-files\dim_products.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
...
FROM 'C:\Users\M.I COMPUTERS\Downloads\cd6ca6c9bd83423ba5eabf06ab3d50f2\sql-data-analytics-project\datasets\flat-files\fact_sales.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
...
AVG(avg_price) OVER (ORDER BY order_date) AS moving_total_sales
FROM
(
SELECT
...
count how many prodcuts fall into each segment*/ 
...
SELECT  
age_group,
COUNT(customer_number) AS total_numbers,
